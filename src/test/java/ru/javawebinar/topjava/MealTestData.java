...
public class MealTestData {
    ...
    public static final List<Meal> allMeals = Arrays.asList(adminMeal2, adminMeal1, meal7, meal6, meal5, meal4, meal3, meal2, meal1);
    public static final List<Meal> mealsByUser = Arrays.asList(meal7, meal6, meal5, meal4, meal3, meal2, meal1);
